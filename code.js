            ...
            if (/[0-9.+*/-]/.test(event.target.innerText) === true){
                ...
                try{
                    ...
                    try {
                        ...
                        toast.className = "toast position-fixed d-block bg-danger bg-opacity-50 fade show";
...
function copy(){
    try {
        ...
        try{
            navigator.clipboard.writeText(document.getElementById('expression').value);

            let alertSuccess = document.createElement("div");
            let text = document.createElement("p")
            let btnClose = document.createElement("button")

            alertSuccess.className = "alert alert-dismissible position-fixed alert-success fade show"
            ...
            btnClose.style.minHeight = "30px !important"
            ...
            alertWrong.className = "alert alert-dismissible position-fixed alert-danger fade show"
